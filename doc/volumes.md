...
Copy and customize [nginx.yml](https://github.com/devilbox-community/vhost-gen/blob/master/etc/templates/nginx.yml) into this mounted directory for global vhost customizations.
